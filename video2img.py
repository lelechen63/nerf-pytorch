...
parser.add_argument('--v_path', type=str, default='/home/cxu-serve/u1/lchen63/github/nerf-pytorch/data/lele_data3/video/IMG_0299.MOV',
                    help='input video path')
parser.add_argument('--v_id', type=str, default='IMG_0299',
                    help='input video path')
